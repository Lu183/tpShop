...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="/Template/pc/default/Static/css/integral.css">
    <link rel="stylesheet" href="/Template/pc/default/Static/css/page.css">
    <style type="text/css">
    	...
    	<div class="main">
        	<div class="exchange">
                <ul id="cate_ul">
                    ...
                    <?php if(is_array($goods_category)): $i = 0; $__LIST__ = $goods_category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gc): $mod = ($i % 2 );++$i;?><li <?php if($_GET['id'] == $gc['id']): ?>class="travel"<?php endif; ?>>
